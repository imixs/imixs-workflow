 ...
 * from an Microsoft Active Directory (AD) by a given username.
 * Therefore the Plugin expects an JNDI Ressource to the corresponding directory
 * identified by the jndi name: 'org.imixs.mail.directory'
 * <p>
 * The search phrase is <code>(samAccountName=%u)</code> where %u is the username to be
 ...
 * 
 */
public class ADMailPlugin extends MailPlugin {
	...
	private String fetchEmail(String aUsername) throws NamingException {
		...
		String searchfilter = "";
		searchfilter = "(samAccountName=" + aUsername + ")";
