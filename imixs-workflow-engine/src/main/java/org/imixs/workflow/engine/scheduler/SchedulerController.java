...
/**
 * The SchedulerController is a front-end controller to start and stop schedulers. A scheduler
 * configuration is defined by the item type="scheduler" and the item name.
 * <p>
...
public class SchedulerController implements Serializable {
  ...
  /**
   * This method load the config entity after postContstruct. If no Entity exists than the
   * ConfigService EJB creates a new config entity.
   * 
   */
  @PostConstruct
  public void init() {
