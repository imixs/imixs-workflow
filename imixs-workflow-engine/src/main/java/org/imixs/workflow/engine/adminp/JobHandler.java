...
public interface JobHandler {
  ...
  /**
   * Called by the AdminPService. The JobHandler returns the job description with pre defined fields
   * to signal the status.
   * 
   * The AdminPService will terminate the job in cases the job is complete. Otherwise the
   * AdminPServcie will wait for the next timeout.
   * <p>
   * Fields:
   * <ul>
   ...
   * <li>isCompleted - boolean indicates if job is completed - controlled by job handler</li>
   * </ul>
   * 
