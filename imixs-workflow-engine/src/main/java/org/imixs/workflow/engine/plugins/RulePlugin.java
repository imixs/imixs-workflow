...
public class RulePlugin extends AbstractPlugin {
  ...
  /**
   * The run method evaluates a script provided by an activityEntity with the specified
   * scriptEngine.
   * 
   * After successful evaluation the method verifies the object value 'isValid'. If isValid is false
   * then the method throws a PluginException. In addition the method evaluates the object values
   * 'errorCode' and 'errorMessage' which will be part of the PluginException.
   * 
   * If 'isValid' is true or undefined the method evaluates the object value 'followUp'. If a
   * followUp value is defined by the script the method update the model follow up definition.
   * 
   * If a script changes properties of the activity entity the method will evaluate these changes
   * and update the ItemCollection for further processing.
   * 
   */
  public ItemCollection run(ItemCollection adocumentContext, ItemCollection adocumentActivity)
    ...
    ItemCollection result =
        ruleEngine.evaluateBusinessRule(script, adocumentContext, adocumentActivity);
  ...
  /**
   * This method evaluates the script result without a 'result' JSON object. This kind of scripts is
  ...
  /**
   * This method injects new properties provided by the script element 'event' into the current
   * ActivityEntity. The new value can be used for further processing.
   * 
   * @param engine
   * @param event
