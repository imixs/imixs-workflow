...
import org.imixs.workflow.engine.plugins.ReplaceItemValueAdapter;
...
/**
 * Test the replaceTextAdapter
 * 
 * @author rsoika
 * 
 */
public class TestReplaceTextAdapter {
	public ItemCollection documentContext;
	public ItemCollection documentActivity;
	private final static Logger logger = Logger.getLogger(TestReplaceTextAdapter.class.getName());

	ReplaceItemValueAdapter replaceTextAdapter=null;
	@Before
	public void setup() throws PluginException {
		replaceTextAdapter=new ReplaceItemValueAdapter();
	}
	...
	public void testReplaceDynamicValues() throws PluginException {
		...
		String resultString = replaceTextAdapter.replaceText(testString, documentContext);
	...
	public void testReplaceDynamicValuesFormatError() {
		...
		try {
			resultString = replaceTextAdapter.replaceText(testString, documentContext);
