 ...
 * **AFTER\_PROCESS** - is send immediately after a workitem was processed but before the document is [saved](https://www.imixs.org/doc/engine/documentservice.html#The_CDI_DocumentEvent).
