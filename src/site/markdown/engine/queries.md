...
The Imixs-Workflow engine takes also a list of [workflow data items](../quickstart/workitem.html) into the index. These items can be used to search for documents of a specific type or category:
