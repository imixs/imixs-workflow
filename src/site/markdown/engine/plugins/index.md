...
The _AbstractPlugin_ provides a method to replace a static string with properties provided by the  processed workitem or a property value. 
This is useful if a string constant need to be updated with values from the current workitem. 
...
### Replacing static Strings with a property value
