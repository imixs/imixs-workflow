 ...
 * 
 * A business rule can be written in any script language supported by the JVM. The Script Language
 * is defined by the property 'txtBusinessRuleEngine' from the current Event element. The script is
 * defined by the property 'txtBusinessRule'.
 * 
 * The Script can access all basic item values from the current workItem and also the event by the
 * provided JSON objects 'workitem' and 'event'.
 * 
 * <code>
 ...
 * </code>
 * 
 * A script can add new values for the current workitem by providing the JSON object 'result'.
 * 
 * <code>
 *     var result={ someitem:'Hello World', somenumber:1};
 * </code>
 * 
 * Also change values of the event object can be made by the script. These changes will be reflected
 ...
 * </code>
 * 
 * A script can set the variables 'isValid' and 'followUp' to validate a workItem or set a new
 * followUp activity.
 * 
 * <code>
 ...
 * </code>
 * 
 * If the script set the variable 'isValid' to false then the plugin throws a PluginExcpetion. The
 * Plugin evaluates the variables 'errorCode' and errorMessage. If these variables are set by the
 * Script then the PluginException will be updates with the corresponding errorCode and the
 * 'errorMessage' as params[]. If no errorCode is set then the errorCode of the PluginException will
 * default to 'VALIDATION_ERROR'.
 * 
 * If the script set the variable 'followUp' the follow-up behavior of the current ActivityEntity
 * will be updated.
 * 
 * If a script can not be evaluated by the scriptEngin a PluginExcpetion with the errorCode
 * 'INVALID_SCRIPT' will be thrown.
 * 
 * NOTE: all variable names are case sensitive! All JSON object elements are lower case!
 * 
 * @author Ralph Soika
 * @version 3.0
 * 
...
public class RuleEngine {
  ...
  /**
   * This method evaluates the business rule defined by the provided event. The method returns the
   * instance of the evaluated result object which can be used to continue evaluation. If a rule
   * evaluation was not successful, the method returns null.
   * 
   ...
   */
  public ItemCollection evaluateBusinessRule(String script, ItemCollection documentContext,
      ItemCollection event) throws PluginException {
  ...
  /**
   * This method converts a JSON String into a JavaScript JSON Object and evaluates a script.
   * <p>
   * The JSON Object is set as a input variable named 'data' so that the script can access the json
  ...
  /**
   * This method evaluates a boolean expression. The method takes a documentContext as argument.
   * 
   * @param adocumentContext
   * @return ScriptEngine instance
   * @throws PluginException
  ...
  /**
   * This method evaluates a script variable as an native Script array from the script engine. The
   * method returns a Object array with the variable values. If the javaScript var is a String a new
   * Array will be created. If the javaScript var is a NativeArray the method tries to create a java
   * List object.
   * 
   * See the following examples used by the Rhino JavaScript engine bundled with Java 6.
   * http://www.rgagnon.com/javadetails/java-0640.html
   * 
   * @return
   */
  public Object[] evaluateNativeScriptArray(String expression) {
    ...
    try {
      ...
      String jsCode = "importPackage(java.util);" + "var _evaluateScriptParam = Arrays.asList("
          + expression + "); ";
  ...
  /**
   * This method converts the values of an ItemCollection into a Map Object with Arrays of Objects
   * for each value
   * 
   * @param itemCol
   * @return
  ...
  /**
   * This method converts a JSON variable by name into a ItemCollection. The variable is expected as
   * a JSON object holding single values or arrays in the following format
   * 
   * <code>
   * 
   ...
   * 
   * @param engine
   * @return ItemCollection holding the item values of the variable or null if no variable with the
   *         given name exists or the variable has not properties.
   * @throws ScriptException
   */
