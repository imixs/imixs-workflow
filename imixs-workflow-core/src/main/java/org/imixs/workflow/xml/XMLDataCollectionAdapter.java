...
/**
 * An XMLItemCollectionAdapter converts a <code>org.imixs.workflow.xml.XMLItemCollection</code> into
 * a <code> org.imixs.workflow.ItemCollection</code> and reverse
 * 
...
public class XMLDataCollectionAdapter {
  ...
  /**
   * This Method converts a <code>org.imixs.workflow.xml.DocumentCollection</code> into a List of
   * <code>org.imixs.workflow.ItemCollection</code>
   * 
   ...
   * 
   * If the attribute List is provided only the corresponding properties will be returned.
   * 
   * @param documents - collection of ItemCollection objects to be converted
   * @param itemNames - optional list of item names to be converted. If null all items will be
   *                  converted
   * @return
   */
  public static XMLDataCollection getDataCollection(final Collection<ItemCollection> documents,
  ...
  /**
   * This method imports an xml entity data stream and returns a List of ItemCollection objects. The
   * method can import any kind of entity data like model or configuration data an xml export of
   * workitems.
   * 
   ...
   * The method can import any kind of entity data like model or configuration data an xml export of
   * workitems.
   * 
   * @param inputStream xml input stream
   * @throws JAXBException
  ...
  /**
   * This method writes a collection of ItemCollection into a Byte array representing a
   * XMLDataCollection
   * 
   * @param inputStream xml input stream
   * @throws JAXBException
   ...
   * @return List of ItemCollection objects
   */
  public static byte[] writeItemCollection(ItemCollection document)
      throws JAXBException, IOException {
    if (document == null) {
      return null;
    }
