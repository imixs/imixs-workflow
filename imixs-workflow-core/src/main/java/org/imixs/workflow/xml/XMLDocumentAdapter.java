...
/**
 * An XMLDocumentAdapter converts a <code>org.imixs.workflow.xml.XMLDocument</code> into a
...
public class XMLDocumentAdapter {
  ...
  /**
   * This Method converts a <code>org.imixs.workflow.xml.XMLItemCollection</code> into a
   * <code> org.imixs.workflow.ItemCollection</code> Returns null if entity == null
   * 
   * @param entity
   ...
   * 
   * <p>
   * The method verifies if the values stored are basic java types. If not these values will not be
   * converted!
   * 
   * @param document  instance of a ItemCollection to be converted
