...
/**
 * Represents a single item inside a XMLItemCollection. An XMLItem has a name and a value. The value
 * can be any Serializable collection of objects.
 * 
 * @author rsoika
 * 
 */
...
public class XMLItem implements Serializable {
  ...
  /**
   * This method set the value array of the item. The method verifies if the values are from basic
   * type, XMLItem or implementing the Map or List interface.
   * <p>
   ...
   * <a href="http://www.w3.org/TR/2000/REC-xml-20001006#NT-Char">the standard</a>. This method will
   ...
   * <p>
   * In case an object value is an instance of a XMLItem, the method converts the object into the
   * corresponding Map or List interface.
   * <p>
   * 
  ...
  public boolean equals(Object o) {
    ...
    return (name != null && name.equals(_xmlItem.name) && value != null
        && Arrays.equals(value, _xmlItem.value));
  }
  ...
  private static XMLItem[] convertMap(Map<String, Object> map) {
    ...
    for (Entry<String, Object> mapentry : entrySet) {
      ...
      if (mapentry.getValue() instanceof List) {
         ...
         * aList.add(mapentry.getValue().toString()); singleXMLItem.setValue(aList.toArray());
         */
        // Issue 535
  ...
  /**
   * This helper method test if a value if of a basic java type including check for raw arrays,
   * java.lang.*, java.math.*
   * 
   * @return
   */
  ...
  private static boolean isBasicType(java.lang.Object o) {
    ...
    if (o instanceof byte[] || o instanceof String[] || o instanceof boolean[]
        || o instanceof short[] || o instanceof char[] || o instanceof int[] || o instanceof long[]
        || o instanceof float[] || o instanceof double[] || o instanceof Long[]
        || o instanceof Integer[] || o instanceof Double[] || o instanceof Float[]
        || o instanceof Short[] || o instanceof XMLItem[]) {
      return true;
    }
  ...
  /**
   * This helper method converts instances of XMLGregorianCalendar into java.util.Date objects.
   * 
   * See issue #52
   *
   */
