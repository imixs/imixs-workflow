...
/**
 * This Class defines a ValueObject to be used to exchange data structures used by the
 * org.imixs.workflow Framework. Most components of this framework use this wrapper class to easy
 * transport workflow data between the different workflow modules. ValueObjects, particular in J2EE
 * Applications, have the advantage to improve performance of remote method calls. The Imixs
 * ItemCcollection enables a very flexibly and easy to use data structure.
 * 
 * A ItemCollection contains various Items (attributes). Every Item exist of a Name (String) and a
 * list of values (List of Object). Internal every Value is stored inside a Vector Class. All values
 * are stored internally in a Map containing key values pairs.
 * 
 * NOTE: An ItemCollection is not serializable and can not be stored into another ItemCollection. To
 * serialize a ItemCollection use the XMLItemCollection. @see XMLItemCollectionAdapter.
 * 
 * 
 * @author Ralph Soika
 * @version 2.1
...
public class ItemCollection implements Cloneable {
  ...
  /**
   * Creates a new ItemCollection by a reference to a given value Map. This method does not make a
   * deep copy of the given map and sets the value map by reference. This method can be used in
   * cases where values are only read. In all other cases, the constructor method
   * 'ItemCollection(Map<String, List<Object>> map)' should be used.
   * 
  ...
  /**
   * This method clones the current ItemCollection. The method makes a deep copy of the current
   * instance.
   */
  @Override
  public Object clone() {
  ...
  /**
   * This method clones the current ItemCollection with a subset of items. The method makes a deep
   * copy of the current instance and removes items not defined by the list of itemNames.
   * 
  ...
  /**
   * This method compares the values of two item collections by comparing the hash maps. This did
   * not garantie that also embedded arrays are equal.
   */
  ...
  /**
   * Set the value of an item. If the ItemCollection does not contain an item with the specified
   * name, the method creates a new item and adds it to the ItemCollection. The ItemName is not case
   * sensitive. Use hasItem to verify the existence of an item. All item names will be lower cased.
   * <p>
   * Each item can contain a list of values (multivalue item). If a single value is provided the
   * method creates a List with one single value (singlevalue item).
   * <p>
   * If the value is null the method will remove the item. This is equal to the method call
   * removeItem()
   * <p>
   ...
   * @param itemValue The value of the new item. The data type of the item depends upon the data
   *                  type of value, and does not need to match the data type of the old item.
   */
  ...
  /**
   * Appends a value to an existing item. If the ItemCollection does not contain an item with the
   * specified name, the method creates a new item and adds it to the ItemCollection. The ItemName
   * is not case sensitive. Use hasItem to verify the existence of an item. All item names will be
   * lower cased.
   * 
  ...
  /**
   * Returns the value list for the specified Item. The returned list is untyped and the values
   * contained in the list are not converted to a specific type. The values have the same object
   * type as set by calling the method <code>setItemValue(String itemName, Object itemValue)</code>.
   * To get a typed value list, see the method
  ...
  /**
   * Returns the resolved item value of the specified type. The method converts the value to the
   * specified type if possible, otherwise the method returns null. If the item has multiple values,
   * this method returns the first value.
   * <p>
   * If the item isn't present in the itemCollection the method returns null.
   * <p>
   * If the specified type is int, float, long, double, Integer, Float, Long or Double, the method
   * returns 0 instead of null
   * <p>
   * If the item contains no value with the specified type, the method returns null. The ItemName is
   * not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The item Name.
   * @param itemType The type into which the resolve item value should get converted
  ...
  /**
   * Returns the resolved list of item values of the specified type. The method converts the values
   * of the list to the specified type if possible.
   * <p>
   ...
   * 
   * @param itemName The item Name.
   * @param itemType The type into which the resolved item values should get converted
   ...
   * @return true if an item with name exists in the document, false if no item with name exists in
   *         the document
   * 
   */
  ...
  /**
   * replaces the current map object. In different to the method replaceAllItems this method
   * overwrites the hash object and did not copy the values
   * 
   * @param aHash
   */
  ...
  /**
   * Replaces the value of an item. If the ItemCollection does not contain an item with the
   * specified name, the method creates a new item and adds it to the ItemCollection. The ItemName
   * is not case sensitive. Use hasItem to verify the existence of an item. All item names will be
   * lower cased.
   * <p>
   ...
   * removeItem()
   * <p>
   * If the ItemValue is not serializable the item will be removed. This method is deprecated and
   * should be replaced by the method setItemvValue.
   * 
  ...
  /**
   * Returns the resolved String value of the specified item. The method converts the stored value
   * to a String. If the item has no value, the method returns an empty String. If the item has
   * multiple values, this method returns the first value.
   * <p>
   * The ItemName is not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The name of an item.
  ...
  /**
   * Returns the resolved Integer value of the specified item. The method converts the stored value
   * to an Integer. If the item has no value or the value is not convertible to an Integer, the
   * method returns 0. If the item has multiple values, this method returns the first value.
   * <p>
   * The ItemName is not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The name of an item.
  ...
  /**
   * Returns the resolved Long value of the specified item. The method converts the stored value to
   * long. If the item has no value or the value is not convertible to a Long, the method returns 0.
  ...
  /**
   * Returns the resolved Date value of the specified item. If the item has no value or the value is
   * not of the type Date, the method returns null. If the item has multiple values, this method
  ...
  /**
   * Returns the resolved LocalDateTime value of the specified item. The method converts a Date
   * object into a LocalDateTime object using the ZoneId.systemDefault().
   * <p>
   * Note: internaly the ItemCollection store LocalDateTime values as Date objects!
   * <p>
   * If the item has no value or the value is not of the type Date, the method returns null. If the
  ...
  /**
   * Returns the resolved Double value of the specified item. The method converts the stored value
   * to double. If the item has no value or the value is not convertible to a Double, the method
   * returns 0.0. If the item has multiple values, this method returns the first value.
   * <p>
   * The ItemName is not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The name of an item.
  ...
  /**
   * Returns the resolved Float value of the specified item. The method converts the stored value to
   * float. If the item has no value or the value is not convertible to a Float, the method returns
   * 0.0. If the item has multiple values, this method returns the first value.
   * <p>
   * The ItemName is not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The name of an item.
  ...
  /**
   * Returns the resolved Boolean value of the specified item. The method converts the stored value
   * to Boolean. If the item has no value or the value is not convertible to a Boolean, the method
   * returns false. If the item has multiple values, this method returns the first value.
   * <p>
   * The ItemName is not case sensitive. Use hasItem to verify the existence of an item.
   * 
   * @param itemName The name of an item.
  ...
  /**
   * Replaces all items specified in the map with new items, which are assigned to the specified
   * values inside the map.
   * 
   * The method makes a deep copy of the source map using serialization. This is to make sure, that
   * no object reference is copied. Other wise for example embedded arrays are not cloned. This is
   * also important for JPA to avoid changes of attached entity beans with references in the data of
   * an ItemCollection.
   * 
   * @see deepCopyOfMap
   * @param map
  ...
  /**
   * Merges all items from a source map into the current instance. Only Items will be copied if the
   * current instance does not have an item with the same name. If you want to copy all item values,
   * use the method replaceAllItems instead.
   * <p>
   * The method makes a deep copy of the source map using serialization. This is to make sure, that
   * no object reference is copied. Other wise for example embedded arrays are not cloned. This is
   * also important for JPA to avoid changes of attached entity beans with references in the data of
  ...
  /**
   * This method adds a fileData object to the ItemCollection. The item '$file' stores all data
   * objects.
   * 
  ...
  /**
   * This method adds a single file to the ItemCollection. files will be stored into the property
   * $file.
   * 
  ...
  /**
   * Returns a data object for an attached file. The data object is a list containing the
   * contentType (String) and the content (byte[])
   * 
   * @param filename
  ...
  /**
   * Returns files stored in the property '$file'. The files are returned in a Map interface where
   * the key is the filename and the value is a list with two elements - the ContenType and the file
   * content (byte[]). s Files can be added into a ItemCollection using the method addFile().
   * 
   * @return
   */
  @Deprecated
  ...
  /**
   * Returns a list of file names attached to the current workitem. File Attachments can be added
   * using the method addFile().
   * 
   * @return
   */
  @SuppressWarnings("unchecked")
  ...
  public int getTaskID() {
    ...
    if (result == 0 && hasItem("$processid") && getItemValueInteger("$processid") != 0) {
      // see issue #384
      /*
       * logger. warning("The field $processid is deprecated. Please use $taskid instead. " +
  ...
  /**
   * Set the event id for a workitem. If a event id is already set, the method appends the event to
   * the ACTIVITYIDLIST
   * 
   * @param eventID
   * @return
  ...
  private void setItemValue(String itemName, Object itemValue, boolean append) {
    ...
    if (!validateItemValue(itemValueList)) {
      String message = "setItemValue failed for item '" + itemName
          + "', the value is a non supported object type: " + itemValue.getClass().getName()
          + " value=" + itemValueList;
  ...
  /**
   * This method validates of a itemValue is acceptable for the ItemCollection. Only basic types are
   * supported.
   * 
   * @param itemValue
   * @return
  ...
  /**
   * This helper method test if an object is a basic type which can be stored in an ItemCollection.
   * 
  ...
  private static boolean isBasicType(java.lang.Object o) {
    ...
    if (o instanceof byte[] || o instanceof boolean[] || o instanceof short[] || o instanceof char[]
        || o instanceof int[] || o instanceof long[] || o instanceof float[]
        || o instanceof double[] || o instanceof XMLItem[] || o instanceof XMLDocument[]) {
      return true;
    }
    ...
    if (name.startsWith("java.lang.") || name.startsWith("java.math.")
        || "java.util.Date".equals(name) || "org.imixs.workflow.xml.XMLItem".equals(name)
  ...
  /**
   * This helper method makes a deep copy of a map by serializing and deserializing.
   * 
   * It is assumed that all elements in the object's source graph are serializable.
   * 
  ...
  /**
   * This class helps to adapt the behavior of a single value item to be used in a jsf page using a
  ...
  class ItemAdapter implements Map<String, Object> {
    ...
    /**
     * returns a single value out of the ItemCollection if the key does not exist the method will
     * create a value automatically
     */
  ...
  /**
   * This class helps to addapt the behavior of a multivalue item to be used in a jsf page using a
   * expression language like this:
   * 
  ...
  class ItemListAdapter extends ItemAdapter {
    ...
    /**
     * returns a multi value out of the ItemCollection if the key dos not exist the method will
     * create a value automatical
     */
    public Object get(Object key) {
      // check if a value for this key is available...
      // if not create a new empty value
