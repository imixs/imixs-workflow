 ...
 * <p>
 * A FileData object contains at least the attributes 'name', 'content' and 'contentType'. The
 * optional object custom attributes can be added. It represents a {@code Map<String, List<Object>>}
 * 
...
public class FileData {
  ...
  /**
   * Returns the value of the named custom attribute as an Object, or null if no attribute of the
   * given name exists. A custom attribute can be set by the method setAttribute().
   * 
