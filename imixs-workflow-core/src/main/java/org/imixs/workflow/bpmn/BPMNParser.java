...
/**
 * This class parses an BPMN model and transform the content into a Imixs Workflow Model definition.
 * 
 * 
 * 
 * 
...
public class BPMNParser {
  ...
  /**
   * This method parses a BPMN model from a input stream and returns a instance of BPMNModel class.
   * The InputStream is converted into a byte array to be stored into the BPMNModel as rawData. The
   * rawData can be used to persist the input stream.
   * 
   * 
  ...
  public final static BPMNModel parseModel(InputStream bpmnInputStream, String encoding)
    ...
    logger.fine("...BPMN Model '" + model.getVersion() + "' parsed in "
