...
/**
 * The AjaxFileUploadServlet is a Multipart-Servlet 3.0. It is used by the imixsFileUplad widget.
 * The widget is using a jQuery component to handle the upload of multiple files and supports drag &
 * drop functionality. The servlet is configured with a max file size to 10MB, and a max request
 * size of 50MB.
 * 
 * @author rsoika
 *
...
public class AjaxFileUploadServlet extends HttpServlet {
  ...
  /**
   * test and extracts the filename of a http request part. The method returns null if the part dose
   * not contain a file
   * 
   * @param part
  ...
  /**
   * This method converts mulitple files from the httpRequest into a list of FileData objects.
   * 
   * @param httpRequest
  ...
  /**
   * This method write a JSON meta data structure for uploaded files into the httpResponse. This
   * structure is used by the ajax jquery file control. (see the imixs-faces.js file)
   * 
   * 
   * <code>
  		{
