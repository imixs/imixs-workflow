...
@Produces({ MediaType.TEXT_HTML, MediaType.APPLICATION_XHTML_XML, MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON,
		MediaType.TEXT_XML })
@Stateless
public class ModelRestServiceV40 {
	private static Logger logger = Logger.getLogger(ModelRestServiceV40.class.getName());
	...
	@EJB
	WorkflowRestServiceV40 workflowRestService;
	...
	public XMLItemCollection getTask(@PathParam("version") String version, @PathParam("taskid") int processid,
		...
		try {
			...
			return XMLItemCollectionAdapter.putItemCollection(process, getItemList(items));
