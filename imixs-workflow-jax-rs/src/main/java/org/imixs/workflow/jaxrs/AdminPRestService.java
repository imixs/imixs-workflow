...
public class AdminPRestService {
   ...
   * 
   * Note: the method merges the content of the given entity into an existing one because the
   * EntityService method save() did not merge an entity. But the rest service typically consumes
   * only a subset of attributes. So this is the reason why we merge the entity here. In different
   * to the behavior of the EntityService the WorkflowService method process() did this merge
   * automatically.
   * 
