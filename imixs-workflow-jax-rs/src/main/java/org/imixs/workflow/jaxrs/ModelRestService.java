 ...
 */
@Path("/model")
@Produces({MediaType.TEXT_HTML, MediaType.APPLICATION_XHTML_XML, MediaType.APPLICATION_XML,
...
public class ModelRestService {
  ...
  static List<String> modelEntityTypes =
      Arrays.asList("WorkflowEnvironmentEntity", "processentity", "activityentity");
  ...
  public StreamingOutput getModelOverview() {
    return new StreamingOutput() {
      public void write(OutputStream out) throws IOException, WebApplicationException {
        ...
        out.write(
            "table {padding:0px;width: 75%;margin-left: -2px;margin-right: -2px;}".getBytes());
        out.write(
    ...
    try {
      ...
      for (String modelVersion : modelVersionList) {
        ...
        if (modelEntity != null) {
          ...
          buffer.append("<td><a href=\"" + rootContext + "/model/" + modelVersion + "/bpmn\">"
              + modelVersion + "</a></td>");
  ...
  @GET
  @Path("/{version}/tasks/")
  public XMLDataCollection findAllTasks(@PathParam("version") String version,
  ...
  public Response getModelFile(@PathParam("version") String version, @Context UriInfo uriInfo) {
    ...
    if (modelEntity != null) {
      return workflowRestService.getWorkItemFile(modelEntity.getUniqueID(),
          modelEntity.getFileNames().get(0), uriInfo);
    } else {
  ...
  public XMLDataCollection getTask(@PathParam("version") String version,
  ...
  public XMLDataCollection findTasksByGroup(@PathParam("version") String version,
   ...
   * The Method expects a subresource with a ModelVersion. Next the method updates each Entity
   * object with the property $ModelVersion. An old version will be automatically removed before
   * update.
   * 
  ...
  public void putModelByVersion(@PathParam("version") final String _modelVersion,
   ...
   * 
   * The method takes the first entity to get the provided $modelVersion. An old version will be
   * automatically removed before update.
   * 
   * @param ecol
   */
  @PUT
