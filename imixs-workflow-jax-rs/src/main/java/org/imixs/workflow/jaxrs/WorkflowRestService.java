...
public class WorkflowRestService {
	 ...
	 * WorkflowService EJB.
	 * <p>
	 * The Method returns a workitem with the new data. If a processException
	 * Occurs the method returns an object with the error code
	 * <p>
	 * The JSON is parsed manually by teh imixs json parser.
	 * The expreced notation is: 
	 * <p><code>... value":{"@type":"xs:int","$":"10"}</code>
	 * 
	 * 
	 * @param requestBodyStream
	 *            - form content
